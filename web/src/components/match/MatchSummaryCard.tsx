    ...
    <Card>
      <CardHeader>
        <CardTitle className="text-lg flex items-center gap-2">
          {state.status === 'loading' ? 'Generating summary…' : (summary?.headline ?? fallback.headline)}
          <span className="rounded bg-muted px-2 py-0.5 text-[10px] uppercase tracking-wide text-muted-foreground">AI-generated</span>
        </CardTitle>
      </CardHeader>
        ...
        {state.status === "loading" ? (
          ...
          <>
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 pt-2">
              <div className="text-[11px] text-muted-foreground">This summary is generated by AI and may contain mistakes.</div>
            </div>
          </>
        )}
      </CardContent>
